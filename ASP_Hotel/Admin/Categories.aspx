    ...
    <asp:GridView class="table table-bordered" runat="server" ID="grdcategories" AutoGenerateColumns="false">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Sửa">
                <ItemTemplate>
                    <asp:Button class="btn btn-info" ID="updateCategories" CommandName="updatecategories" CommandArgument='<%#Bind("cat_id") %>' Text="Sửa" OnCommand="updateCategories_Command" runat="server" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
